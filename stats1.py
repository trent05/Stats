...
print("The variance alcohol of consumption is ") + str(varA)
print("The variance tobacco of consumption is ") + str(varT)
print("The standard deviation of alcohol consumption is ") + str(stdA)
print("The standard deviation of tobacco consumption is ") + str(stdT)
